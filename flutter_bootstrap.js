...
// `viewport-fit=cover`, leaves out the strip behind the status bar and hands the
// app a viewport shorter than the screen.
//
// No `serviceWorkerSettings`: the build ships without a worker
// (`--pwa-strategy=none`), because a cached index.html is served for a whole
// extra load after a deploy.
